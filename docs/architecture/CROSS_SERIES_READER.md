...
- The Reading Lists screen exposes Read/Resume as the leading control for each list; review, search, source editing, and deletion remain separate trailing actions.
