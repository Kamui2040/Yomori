...
- The Reading Lists screen exposes an explicit read/resume action as the leading action for each list; review, search, source editing, and deletion remain separate.
